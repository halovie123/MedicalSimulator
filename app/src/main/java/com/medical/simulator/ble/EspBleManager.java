 ...
 * └─────────────────────────────────────────────────────────────────┘
 */
public class EspBleManager extends BleManager {

    private static final String TAG = "EspBleManager";
    ...
    public EspBleManager(@NonNull Context context) {
        super(context);
    }
        ...
        protected void initialize() {
            ...
            if (notifyCharacteristic != null) {
                ...
                setNotificationCallback(notifyCharacteristic)
                        .with(EspBleManager.this::handlePpgNotification);
                ...
                errorEvent.postValue("UUID sóng PPG sai — xem Logcat tag EspBleManager");
            }

            // ── Subscribe STATUS characteristic (HR/SpO2/RR) ──
            if (statusCharacteristic != null) {
                setNotificationCallback(statusCharacteristic)
                        .with(EspBleManager.this::handleStatusNotification);
